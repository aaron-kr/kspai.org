  ...
  <div class="news-list">
    ...
    <div class="news-list-item">
      <div class="news-list-tag-date">
        <span class="news-tag {{ post.tag_class }} en" style="margin-bottom:0;">
          <span data-lang="ko">{{ post.tag_ko }}</span>
          <span data-lang="en">{{ post.tag_en }}</span>
        </span>
        <span class="news-date mono" style="margin-top:0;">
      ...
      <div class="news-list-body">
        ...
        <p class="news-excerpt" style="font-size:14px;">
