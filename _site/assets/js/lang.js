...
const translations = {
  ...
  "society.name":    { ko: "한국피지컬인공지능학회", en: "Korean Society for Physical AI" },
  "society.name.en": { ko: "Korean Society for Physical AI (KSPAI)", en: "한국피지컬인공지능학회 (KSPAI)" },
